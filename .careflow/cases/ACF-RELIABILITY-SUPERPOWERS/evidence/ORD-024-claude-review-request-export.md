...
TARGET_TOOL: claude
EXPECTED_REVIEW_PATH: .careflow/cases/ACF-RELIABILITY-SUPERPOWERS/reviews/REVIEW-CLAUDE-ORD-024.review.md

# REVIEW REQUEST: REVIEW-CLAUDE-ORD-024
...
- Order: `.careflow/cases/ACF-RELIABILITY-SUPERPOWERS/orders/ORD-024.order.md`
- Result: `.careflow/cases/ACF-RELIABILITY-SUPERPOWERS/results/ORD-024.result.md`
...
```bash
agent-careflow review import --case ACF-RELIABILITY-SUPERPOWERS --source /path/to/REVIEW-CLAUDE-ORD-024.review.md --strict
```
