...
TARGET_TOOL: claude
EXPECTED_REVIEW_PATH: .careflow/cases/ACF-RELIABILITY-SUPERPOWERS/reviews/REVIEW-CLAUDE-ORD-013.review.md

# REVIEW REQUEST: REVIEW-CLAUDE-ORD-013
...
- Order: `.careflow/cases/ACF-RELIABILITY-SUPERPOWERS/orders/ORD-013.order.md`
- Result: `.careflow/cases/ACF-RELIABILITY-SUPERPOWERS/results/ORD-013.result.md`
...
```markdown
# REVIEW: REVIEW-CLAUDE-ORD-013

review_id: REVIEW-CLAUDE-ORD-013
case_id: ACF-RELIABILITY-SUPERPOWERS
tool: claude
...
result_path: .careflow/cases/ACF-RELIABILITY-SUPERPOWERS/results/ORD-013.result.md
